...
<body>
	...
	<div class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="TeacherAction_getStudent"> <img
	...
	<header id="head" class="secondary" 
		style="height:100px; background:url(image/xueshengchengjibiao1.png) ">
						...
						<div class="portfolio-items isotopeWrapper clearfix" id="3">
							...
							<s:iterator value="#request.listY" var="stu" status="st">
								...
								<div class="portfolio-item" style="text-align: center;">
									<img src='image/touxiang/<s:property value='#stu.snumber'/>.jpg' alt="" />
