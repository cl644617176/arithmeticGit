...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li class="c2 "><a href="UserAction_goPerson">个人中心</a></li>
	...
	<div class="row row1">
		<div class="col-md-4 col-md-offset-2 dx1"
			style="width:500px; background-image: url(image/cube/1.png)">
			<div class="innerDiv zt" id="t1" style="float: center;margin-top: 20px;">1+1</div>
		</div>
		<div class="col-md-4 dx2 "
			...
			<div class="innerDiv zt">
				<input id="d1" type="text"
					style="border:0px;background:rgba(0, 0, 0, 0);width: 150px;height: 80px;">
			</div>
		</div>
	...
	<div class="row row1" style="margin-top:20px">
		<div class="col-md-4 col-md-offset-2 dx1"
			style="width:500px;background-image: url(image/cube/3.png);">
			<div class="innerDiv zt" id="t2" style="float: center;margin-top: 20px;">2+2+2</div>
		</div>
		<div class="col-md-4 dx2 "
	...
	<div class="row row1" style="margin-top:20px">
		<div class="col-md-4 col-md-offset-2 dx1"
			style=" width:500px;background-image: url(image/cube/5.png)">
			<div class="innerDiv zt" id="t3" style="float:center right;margin-top: 20px;">3+3+3+3</div>
		</div>
		<div class="col-md-4 dx2 "
	...
	<div class="row row1" style="margin-top:20px">
		<div class="col-md-4 col-md-offset-2 dx1"
			style="width:500px;background-image: url(image/cube/7.png)">
			<div class="innerDiv zt" id="t4" style="float: center;margin-top: 20px;">4+4+4+4+4</div>
		</div>
		<div class="col-md-4 dx2"
	...
	<div class="row row1" style="margin-top:20px">
		<div class="col-md-4 col-md-offset-2 dx1"
			style="width:500px;background-image: url(image/cube/9.png)">
			<div class="innerDiv zt" id="t5" style="float: center;margin-top: 20px;">5+5+5+5+5+5</div>
		</div>
		<div class="col-md-4 dx2 "
							...
							style : {
								...
								daysElement : {
									...
									gauge : {
										...
										fgColor : "rgba(255,255,255,1.5)",//深的时间
										lineCap : 'round'
									},
