...
<div style="height:20px"></div>
<div>
	<a href="home.jsp"><button type="button" class="button" style="background-image:url(image/back.jpg) ; margin-left:500px; width:200px; height:60px;"></button></a>
    <button type="button" class="button" style="margin-left:200px; width:55px; height:55px; background:url(image/down.png); font-size:18px" onclick="Dow();"></button>
</div>
</div>
