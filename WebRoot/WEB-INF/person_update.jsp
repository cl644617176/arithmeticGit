		...
		<div class="container" style="height: 450px;">
			<div class="col-md-4" style="float: left; width: 200px;">
				<ul class="nav nav-list">
					...
					<li><a href="UserAction_inforTJ">信息统计</a></li>
					<li><a href="#">私人定制</a></li>
					<li class="divider"></li>
					<li><a href="#">帮助</a></li>
				</ul>
						...
						<div class="span12">
							<h3 class="text-center">个人信息修改</h3>
								<div class="control-group">
									...
									<div class="controls">
										<input id="s_number" type="text" name="s_number" disabled="disabled" value="${requestScope.student.snumber }" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="inputEmail">老师:</label>
									<div class="controls">
										<input id="inputEmail" type="text" disabled="disabled" value="${requestScope.tname }"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="inputEmail">姓名:</label>
									<div class="controls">
										<input id="inputEmail" type="text" disabled="disabled" value="${requestScope.student.sname }"/>
									</div>
								</div>
								<div class="control-group">
