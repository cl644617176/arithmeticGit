...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li class="c5 active"><a href="GradeRecordAction_getRank">排行榜</a></li>
					<li class="c6 dropdown"><a href="ExamAction_goExam?flag=primary"
	...
	<header id="head" class="secondary" style="background:url(image/rank.png) no-repeat;">
            <div class="container">
			...
			<s:iterator value="#request.rankList" var="rank" status="st">
				<s:if test="#st.index==0">
					...
					<img alt="冠军" src="image/t_1.png" style="width: 30px;height: 30px;">
					 <span style="display:inline-block; width:50px; color:#FF44AA; font-size:25px;margin-left:118px;"><s:property value="#rank.name" /></span>
				...
				<s:else>
					<li style="margin-left: 5px;"><em><s:property value="#st.index+1" /></em> <span style="display:inline-block; width:50px;color:#FF44AA; font-size:25px;margin-left:150px;"><s:property value="#rank.name" /></span>
					 <span style="color:#FF3333; font-size:25px;margin-left:100px;"><s:property
								value="#rank.gscore" />分</span></li>
				</s:else>
