...
<body>
	...
	<header id="head" class="secondary" style="background:url(image/exercise.png) no-repeat; background-size:cover">
            <div class="container">
	...
	<div class="row" style="margin-top:20px">
		<div class="col-md-4 col-md-offset-4 text-center">
			...
			<a href="home.jsp"><img src="image/back.jpg" class="img-rounded" id="imageBc"
				height="50" style="margin-left:30px "/></a>
		</div>
	</div>
	<div class="row" style="margin-top:20px">
		<div class="col-md-4 col-md-offset-4 text-center">
