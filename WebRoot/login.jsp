...
<script type="text/javascript">
	function JudgeAll() {
		...
		if (flag == 1) {
			...
			$.ajax({
				type : "POST",
				url : "UserAction_loginCheck",
				dataType : "text",
				data : {
					loginNumber : $("#snumber").val(),
					loginPassword : $("#spassword").val(),
					role : role
				},
...
<body>
	...
	<div class="login-page-container">
		...
		<form id="form" action="UserAction_login" method="post">
			...
			<input id="snumber" type="text" name="loginNumber" class="username"
				placeholder="学号"> <input id="spassword" type="password"
				name="loginPassword" class="password" placeholder="密码">

			<div style="margin-left:50px;display: inline;">
				<input type="radio" name="role" class="role1" id="radio1"
					style="width: 50;height: 50;margin-top:20px;" value="teacher" /><span
					style="margin-left: 8px">教师</span>


			</div>
			<div style="margin-left:90px;display: inline;">
				<input type="radio" name="role" class="role" id="radio2"
					value="student" checked="checked" /> <span
					style="margin-left: 8px">学生</span>
			</div>

			<button type="button" style="margin-left: 2px"
				onclick="javascropt:return JudgeAll();">登录</button>

		</form>
		<div style="width: 100%;text-align: center;float: left;">
			<a href="register.jsp"><button type="submit"
					style="background-position: center;">去注册</button></a>
		</div>
